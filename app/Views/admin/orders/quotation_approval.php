...
<head>
    ...
    <title>Approve Quotation - <?= $quotation['quotation_number'] ?></title>
        ...
        <div class="bg-green-100 border border-green-400 text-green-700 px-6 py-4 rounded-lg shadow-lg">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-sm">You have already approved this quotation. Repair work is in progress.</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-yellow-100 border border-yellow-400 text-yellow-700 px-6 py-4 rounded-lg shadow-lg">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-sm">You have declined this quotation. Contact us if you'd like to discuss alternatives.</p>
                </div>
            </div>
        </div>
    <?php else: ?>
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-xl shadow-2xl max-w-md w-full p-6">
            <div class="text-center mb-6">
                ...
                <h3 class="text-xl font-bold text-gray-900">Approve Quotation</h3>
                <p class="text-gray-600 mt-2">Confirm that you want to proceed with this repair</p>
            </div>

            <form action="/quotation/<?= $quotation['id'] ?>/approve" method="POST">
                <?= csrf_field() ?>
                <div class="mb-4">
                ...
                <div class="flex space-x-4">
                    <button type="button" onclick="hideApprovalForm()"
...
<!-- Decline Modal -->
<div id="declineModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden">
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-xl shadow-2xl max-w-md w-full p-6">
            <div class="text-center mb-6">
                ...
                <p class="text-gray-600 mt-2">Let us know why you're declining this quotation</p>
            </div>

            <form action="/quotation/<?= $quotation['id'] ?>/reject" method="POST">
                <?= csrf_field() ?>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Reason for Declining *</label>
                    <textarea name="customer_notes" rows="3" required
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                              placeholder="Please tell us why you're declining (too expensive, want different approach, etc.)"></textarea>
                </div>
